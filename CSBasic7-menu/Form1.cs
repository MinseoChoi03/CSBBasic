...
namespace CSBasic7_menu
{
    public partial class Form1 : Form
    {
        ...
        {
            if (toolStripProgressBar1.ProgressBar.Value + 10 < toolStripProgressBar1.ProgressBar.Maximum)
                toolStripProgressBar1.ProgressBar.Value += 10;
            else
                toolStripProgressBar1.Value = toolStripProgressBar1.ProgressBar.Maximum;
        }
